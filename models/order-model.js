...
var OrderSchema =new mongoose.Schema({
    ...
    Order_Status                                : String, // Created (quantity Is Pending), Shipped (Quantity is released form store), Cancelled (canceled before Shipped and quantitiy is removed from pending), Returned (), Collected
